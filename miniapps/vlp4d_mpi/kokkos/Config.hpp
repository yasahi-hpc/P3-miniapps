...
struct Domain {
  ...
  shape_t<DIMENSION> local_nx_;    // Number of points on the local grid
  shape_t<DIMENSION> local_nxmax_; // Maximum of local grid
  shape_t<DIMENSION> local_nxmin_; // Minimum of local grid
