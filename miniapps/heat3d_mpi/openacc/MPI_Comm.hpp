...
public:
  ...
  void cleanup() {
    #if defined(ENABLE_OPENACC)
      #pragma acc exit data delete(x_send_halo_[0:1], x_recv_halo_[0:1])
      #pragma acc exit data delete(y_send_halo_[0:1], y_recv_halo_[0:1])
      #pragma acc exit data delete(z_send_halo_[0:1], z_recv_halo_[0:1])
    #endif
    delete x_send_halo_;
    delete y_send_halo_;
    delete z_send_halo_;
...
private:
  void setTopology() {
    ...
    #if defined(ENABLE_OPENACC)
      #pragma acc enter data create(x_send_halo_[0:1], x_recv_halo_[0:1])
      #pragma acc enter data create(y_send_halo_[0:1], y_recv_halo_[0:1])
      #pragma acc enter data create(z_send_halo_[0:1], z_recv_halo_[0:1])
    #endif
  }
  ...
  void pack(const Config &conf, const RealView3D &u) {
    ...
    // xhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, x_send_halo_->left_buffer_, x_send_halo_->right_buffer_)
    ...
    // yhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, y_send_halo_->left_buffer_, y_send_halo_->right_buffer_)
      #pragma acc parallel loop
    #else
      #pragma omp parallel for
    #endif
    ...
    // zhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, z_send_halo_->left_buffer_, z_send_halo_->right_buffer_)
      #pragma acc parallel loop
    #else
      #pragma omp parallel for
    #endif
  ...
  void unpack(const Config &conf, RealView3D &u) {
    ...
    // xhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, x_recv_halo_->left_buffer_, x_recv_halo_->right_buffer_)
      #pragma acc parallel loop
    #else
      #pragma omp parallel for
    #endif
    ...
    // yhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, y_recv_halo_->left_buffer_, y_recv_halo_->right_buffer_)
      #pragma acc parallel loop
    #else
      #pragma omp parallel for
    #endif
    ...
    // zhalos
    #if defined(ENABLE_OPENACC)
      #pragma acc data present(u, z_recv_halo_->left_buffer_, z_recv_halo_->right_buffer_)
      #pragma acc parallel loop
    #else
      #pragma omp parallel for
    #endif
  ...
  void commP2P(Halo *recv, Halo *send) {
    if(send->is_comm()) {
      ...
      #if defined( ENABLE_OPENACC )
        #pragma acc data present(recv_left_buffer, recv_right_buffer, send_left_buffer, send_right_buffer)
        #pragma acc host_data use_device(recv_left_buffer, recv_right_buffer, send_left_buffer, send_right_buffer)
      #endif
      {
