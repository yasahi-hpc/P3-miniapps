...
#    ../build/heat3d_mpi/stdpar/heat3d_mpi --px 1 --py 1 --pz 1 --nx 512 --ny 512 --nz 512 --nbiter 1000 --freq_diag 0
mpiexec -machinefile $PJM_O_NODEINF -np $PJM_MPI_PROC -report-bindings --map-by ppr:1:socket:PE=36 \
    ../build/heat3d_mpi/stdpar/heat3d_mpi --px 1 --py 1 --pz 2 --nx 512 --ny 512 --nz 256 --nbiter 1000 --freq_diag 0
