...
struct Halo {
  ...
  */
  ...
  value_type *left_data() { return left_buffer_.data(); }
  value_type *right_data() { return right_buffer_.data(); }
  const value_type *left_data() const { return left_buffer_.data(); }
  const value_type *right_data() const { return right_buffer_.data(); }
